...
UNTIL ABS(Runway_Latitude_vector(3)-SHIP:LATITUDE)<0.01 AND abs(Runway_Longitude_vector(3)-SHIP:LONGITUDE)< 0.01{
SET thrott to PID_Thrust:UPDATE(TIME:SECONDS, (SHIP:AIRSPEED-target_v)).
SET SHIP:CONTROL:YAW TO PID_Yaw:UPDATE(TIME:SECONDS, -1*(-Yaw_slip(SHIP) + SIN(Roll_angle(SHIP))*Total_slip(SHIP))).
SET SHIP:CONTROL:PITCH TO PID_Pitch:UPDATE(TIME:SECONDS, SHIP:ALTITUDE-1073).
SET SHIP:CONTROL:ROLL TO PID_Roll:UPDATE(TIME:SECONDS, set_Roll(Runway_Latitude_vector(3), Runway_Longitude_vector(3)) + Roll_angle(SHIP)).

}

UNTIL ABS(Runway_Latitude_vector(2)-SHIP:LATITUDE)<0.01 AND abs(Runway_Longitude_vector(2)-SHIP:LONGITUDE)< 0.01{
SET thrott to PID_Thrust:UPDATE(TIME:SECONDS, (SHIP:AIRSPEED-target_v + 70*(1-distance_to_runway(SHIP:LATITUDE, SHIP:LONGITUDE)/distance_to_runway(Runway_Latitude_vector(3), Runway_Longitude_vector(3))))).
SET SHIP:CONTROL:YAW TO PID_Yaw:UPDATE(TIME:SECONDS, -1*(-Yaw_slip(SHIP) + SIN(Roll_angle(SHIP))*Total_slip(SHIP))).
SET SHIP:CONTROL:PITCH TO PID_Pitch:UPDATE(TIME:SECONDS, SHIP:ALTITUDE- 1073 + 1000 * (1 - distance_to_runway(SHIP:LATITUDE, SHIP:LONGITUDE)/distance_to_runway(Runway_Latitude_vector(3), Runway_Longitude_vector(3)))).
SET SHIP:CONTROL:ROLL TO PID_Roll:UPDATE(TIME:SECONDS, set_Roll(Runway_Latitude_vector(2), Runway_Longitude_vector(2)) + Roll_angle(SHIP)).

}

UNTIL ABS(Runway_Latitude_vector(1)-SHIP:LATITUDE)<0.01 AND abs(Runway_Longitude_vector(1)-SHIP:LONGITUDE)< 0.01{
SET thrott to PID_Thrust:UPDATE(TIME:SECONDS, (SHIP:AIRSPEED - target_v +70*(1-distance_to_runway(SHIP:LATITUDE, SHIP:LONGITUDE)/distance_to_runway(Runway_Latitude_vector(3), Runway_Longitude_vector(3))))).
SET SHIP:CONTROL:YAW TO PID_Yaw:UPDATE(TIME:SECONDS, -1*(-Yaw_slip(SHIP) + SIN(Roll_angle(SHIP))*Total_slip(SHIP))).
SET SHIP:CONTROL:PITCH TO PID_Pitch:UPDATE(TIME:SECONDS, SHIP:ALTITUDE- 1073 + 1000 * (1 - distance_to_runway(SHIP:LATITUDE, SHIP:LONGITUDE)/distance_to_runway(Runway_Latitude_vector(3), Runway_Longitude_vector(3)))).
SET SHIP:CONTROL:ROLL TO PID_Roll:UPDATE(TIME:SECONDS, set_Roll(Runway_Latitude_vector(1), Runway_Longitude_vector(1)) + Roll_angle(SHIP)).
}

UNTIL ABS(Runway_Latitude_vector(0)-SHIP:LATITUDE)<0.01 AND abs(Runway_Longitude_vector(0)-SHIP:LONGITUDE)< 0.01{
SET thrott to PID_Thrust:UPDATE(TIME:SECONDS, (SHIP:AIRSPEED - target_v +70*(1-distance_to_runway(SHIP:LATITUDE, SHIP:LONGITUDE)/distance_to_runway(Runway_Latitude_vector(3), Runway_Longitude_vector(3))))).
SET SHIP:CONTROL:YAW TO PID_Yaw:UPDATE(TIME:SECONDS, -1*(-Yaw_slip(SHIP) + SIN(Roll_angle(SHIP))*Total_slip(SHIP))).
SET SHIP:CONTROL:PITCH TO PID_Pitch:UPDATE(TIME:SECONDS, SHIP:ALTITUDE- 1073 + 1000 * (1 - distance_to_runway(SHIP:LATITUDE, SHIP:LONGITUDE)/distance_to_runway(Runway_Latitude_vector(3), Runway_Longitude_vector(3)))).
SET SHIP:CONTROL:ROLL TO PID_Roll:UPDATE(TIME:SECONDS, set_Roll(Runway_Latitude_vector(0), Runway_Longitude_vector(0)) + Roll_angle(SHIP)).
